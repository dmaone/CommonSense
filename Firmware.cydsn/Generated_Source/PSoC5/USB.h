...
#define USB_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF_SIZE (9u)
...
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF_SIZE_ID2 (3u)
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF_SIZE_ID3 (3u)
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_NUM_IN_RPTS (2u)
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_RPT_SCB USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_RPT_SCB_ID3
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF_ID3
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF_SIZE USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_IN_BUF_SIZE_ID3
#define USB_DEVICE0_CONFIGURATION0_INTERFACE2_ALTERNATE0_HID_COUNT (1u)
#define USB_ENABLE_HID_CLASS                   
#define USB_HID_RPT_1_SIZE_LSB                 (0x41u)
#define USB_HID_RPT_1_SIZE_MSB                 (0x00u)
#define USB_HID_RPT_2_SIZE_LSB                 (0x2Cu)
#define USB_HID_RPT_2_SIZE_MSB                 (0x00u)
#define USB_HID_RPT_3_SIZE_LSB                 (0x22u)
#define USB_HID_RPT_3_SIZE_MSB                 (0x00u)
#define USB_MAX_REPORTID_NUMBER                (3u)
