...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CACHE_CC_CTL), (((CYDEV_INSTRUCT_CACHE_ENABLED) != 0) ? 0xC1u : 0xC0u));
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x40010341u, /* Base address: 0x40010300 Count: 65 */
			...
			0x4001073Eu, /* Base address: 0x40010700 Count: 62 */
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P1_U1_CFG24), 0xC8040004u);
