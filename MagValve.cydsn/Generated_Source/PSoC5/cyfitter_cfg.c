...
void cyfitter_cfg(void)
{
	...
	ClockSetup();
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x4001042Cu, /* Base address: 0x40010400 Count: 44 */
			0x40010531u, /* Base address: 0x40010500 Count: 49 */
		...
		static const uint8 CYCODE BS_IOPORT_7_VAL[] = {
			0x82u, 0x80u, 0x00u, 0x00u, 0x20u, 0x00u};
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B1_P3_U0_CFG24), 0x04048484u);
